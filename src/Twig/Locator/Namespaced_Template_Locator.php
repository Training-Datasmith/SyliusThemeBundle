 ...
 */
final readonly class Namespaced_Template_Locator implements Template_Locator_Interface
{
    ...
    public function locate(string $template, Theme_Interface $theme): string
    {
        ...
        $path = sprintf('%s/templates/bundles/%s/%s', $theme->get_path(), $this->get_bundle_or_plugin_name($twig_namespace), $resource_name);
